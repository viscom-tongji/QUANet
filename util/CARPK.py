...
class CARPK(Dataset):
    def __init__(self, data_dir:str, split:str, subset_scale:float=1.0, resize_val:bool=True):
        ...
        #!HARDCODED Dec 25: 
        self.data_dir = "data/{}_devkit/data/".format(data_dir)
        ...
        for im_name in self.idx_running_set:
            assert os.path.exists(os.path.join(self.im_dir, f"{im_name}.png")) or os.path.exists(os.path.join(self.im_dir, f"{im_name}.jpg"))
    ...
    def __getitem__(self, idx):
        ...
        if os.path.exists(os.path.join(self.im_dir, f"{im_name}.png")):
