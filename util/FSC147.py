...
class FSC147(Dataset):
    def __init__(self, 
        ...
        # with open(self.fsc147_d) as f:
        #     fsc147_data = json.load(f)
        #     for key in fsc147_data.keys():
        #         self.class_dict[key] = fsc147_data[key]['text_description']
...
class ResizeTrainImage(object):
    ...
    def __call__(self, sample):
        ...
        sample = {'image':reresized_image,'boxes':boxes,'gt_density':reresized_density, 'm_flag': m_flag, 'dots': coords}
